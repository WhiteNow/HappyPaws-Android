 ...
 * [NewPetStep1.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [NewPetStep1.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class NewPetStep1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_new_pet_step1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newPetStep1ButtonNext.setOnClickListener {
            (activity as NewPetActivity).swipeToPage2()
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment NewPetStep1.
         */
